...
class DynamicV2Tests(unittest.TestCase):
    ...
    def test_v2_codegen_writes_runtime_module_and_stub(self):
        with tempfile.TemporaryDirectory() as tmp:
            ...
            self.assertTrue(source.startswith("# Copyright (C) 2026 RemoteRF"))
            self.assertTrue(stub.startswith("# Copyright (C) 2026 RemoteRF"))
            self.assertTrue(init_text.startswith("# Copyright (C) 2026 RemoteRF"))
